...
int main()
{
    ...
    if(n%2)
    {
        cout << median_conf(arr,n/2) << endl << median_conf(arr,n)<< endl<< median_conf(arr,(n+n/2+1));
    }
    else
    {
        cout << median_conf(arr,n/2) << endl<<median_conf(arr,n)<< endl << median_conf(arr,(n+n/2));
    }
