    ...
    string decToHexa(int n)
{
    ...
    int main (){
        ...
        for(int i = 0 ; i < n ; i++)
        {
            cin>>arr[i].name>>arr[i].a>>arr[i].m>>arr[i].s>>arr[i].e;
            arr[i].sum=arr[i].a+arr[i].m+arr[i].s+arr[i].e;
        }
        ...
        for(int i = 0 ; i < n ; i++)
        {
            cout<<arr[i].name<< " "<<arr[i].sum<<" "<<arr[i].a<<" "<<arr[i].m<<" "<<arr[i].s<<" "<<arr[i].e<<endl;
        }
}
